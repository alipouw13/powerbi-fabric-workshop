...
**August 18, 2026 · 9:00 to 4:30 · Deck slides 4 to 14**

> **Outcome:** A shared blueprint for how I&O models data.

Day 1 is teaching and alignment. **There are no numbered labs.** The only
hands-on activity is [Lab 0](../labs/lab-00-setup-and-gateway/README.md) in the
...
| 3:30 | Domain alignment and Day 2 setup | Ricky, BRIT | Pick flagship reports per business unit | [Lab 0](../labs/lab-00-setup-and-gateway/README.md) |
...
### 3:30 - Domain alignment and Day 2 setup
Run [Lab 0](../labs/lab-00-setup-and-gateway/README.md). By the end of it:
...
- **Do not demo what they cannot use.** No embedded Copilot, no Data Agent, no
  Lakehouse. A demo of an unavailable capability reads as a sales pitch, not
  enablement.
- **M365 Copilot is fair game**, and slide 24 scopes it. See the note in
  [reference/copilot-in-power-bi.md](../reference/copilot-in-power-bi.md) about
  where the labs go further than slide 24 currently claims.
